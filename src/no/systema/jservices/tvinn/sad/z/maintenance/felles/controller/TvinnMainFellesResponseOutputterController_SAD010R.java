...
@Controller
public class TvinnMainFellesResponseOutputterController_SAD010R {
	private static Logger logger = LoggerFactory.getLogger(TvinnMainFellesResponseOutputterController_SAD010R.class.getName());
	 ...
	 * File: 	TARI
	 * PGM:		SAD010
	 * Member: 	SAD Felles Maintenance - UPDATE SPECIFIC
	 * 
