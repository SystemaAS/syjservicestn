...
public class JsonTvinnMaintFellesResponseWriter extends JsonResponseWriter{
	...
	private static Logger logger = LoggerFactory.getLogger(JsonTvinnMaintFellesResponseWriter.class.getName());
	 ...
	 * @return
	 */
	public String setJsonSimpleValidResult(String user, String status, Integer id){
		StringBuffer sb = new StringBuffer();
		//build the return JSON
		sb.append(JsonConstants.JSON_START);
		sb.append(this.setFieldQuotes("user") + ":" + this.setFieldQuotes(user) + ",");
	 ...
	 * @return
	 */
	public String setJsonSimpleValidResult(String user, String status, Integer id, Integer id2){
		StringBuffer sb = new StringBuffer();
		//build the return JSON
		sb.append(JsonConstants.JSON_START);
		sb.append(this.setFieldQuotes("user") + ":" + this.setFieldQuotes(user) + ",");
	 ...
	 * @return
	 */
	public String setJsonSimpleValidResult(String user, String status, Integer id, Integer id2, Integer id3){
		StringBuffer sb = new StringBuffer();
		//build the return JSON
		sb.append(JsonConstants.JSON_START);
		sb.append(this.setFieldQuotes("user") + ":" + this.setFieldQuotes(user) + ",");
	...
	public String setJsonSimpleValidResult(String user, String status, String id, String id2, String id3, String id4, Integer id5){
		StringBuffer sb = new StringBuffer();
		//build the return JSON
		sb.append(JsonConstants.JSON_START);
		sb.append(this.setFieldQuotes("user") + ":" + this.setFieldQuotes(user) + ",");
		...
		sb.append(JsonConstants.JSON_RECORD_SEPARATOR);
		sb.append(JsonConstants.JSON_OPEN_LIST_RECORD);
		sb.append(JsonConstants.JSON_QUOTES + "id" + JsonConstants.JSON_QUOTES + ":" + JsonConstants.JSON_QUOTES + id + JsonConstants.JSON_QUOTES);
		sb.append(JsonConstants.JSON_CLOSE_LIST_RECORD);
		//NEW RECORD
		sb.append(JsonConstants.JSON_RECORD_SEPARATOR);
		sb.append(JsonConstants.JSON_OPEN_LIST_RECORD);
		sb.append(JsonConstants.JSON_QUOTES + "id2" + JsonConstants.JSON_QUOTES + ":" + JsonConstants.JSON_QUOTES + id2 + JsonConstants.JSON_QUOTES);
		sb.append(JsonConstants.JSON_CLOSE_LIST_RECORD);
		//NEW RECORD
		sb.append(JsonConstants.JSON_RECORD_SEPARATOR);
		sb.append(JsonConstants.JSON_OPEN_LIST_RECORD);
		sb.append(JsonConstants.JSON_QUOTES + "id3" + JsonConstants.JSON_QUOTES + ":" + JsonConstants.JSON_QUOTES + id3 + JsonConstants.JSON_QUOTES);
		sb.append(JsonConstants.JSON_CLOSE_LIST_RECORD);
		//NEW RECORD
		sb.append(JsonConstants.JSON_RECORD_SEPARATOR);
		sb.append(JsonConstants.JSON_OPEN_LIST_RECORD);
		sb.append(JsonConstants.JSON_QUOTES + "id4" + JsonConstants.JSON_QUOTES + ":" + JsonConstants.JSON_QUOTES + id4 + JsonConstants.JSON_QUOTES);
		sb.append(JsonConstants.JSON_CLOSE_LIST_RECORD);
		//NEW RECORD
		sb.append(JsonConstants.JSON_RECORD_SEPARATOR);
		sb.append(JsonConstants.JSON_OPEN_LIST_RECORD);
		sb.append(JsonConstants.JSON_QUOTES + "id5" + JsonConstants.JSON_QUOTES + ":" + id5 );
		sb.append(JsonConstants.JSON_CLOSE_LIST_RECORD);
