...
import no.systema.jservices.tvinn.sad.z.maintenance.felles.model.dao.mapper.KodtlbMapper;
...
public class KodtlbDaoServicesImpl implements KodtlbDaoServices {
	private static Logger logger = LoggerFactory.getLogger(KodtlbDaoServicesImpl.class.getName());
