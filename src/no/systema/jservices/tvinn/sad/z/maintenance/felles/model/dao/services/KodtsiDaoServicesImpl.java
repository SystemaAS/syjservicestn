...
import no.systema.jservices.tvinn.sad.z.maintenance.felles.model.dao.mapper.KodtsiMapper;
...
public class KodtsiDaoServicesImpl implements KodtsiDaoServices {
	private static Logger logger = LoggerFactory.getLogger(KodtsiDaoServicesImpl.class.getName());
