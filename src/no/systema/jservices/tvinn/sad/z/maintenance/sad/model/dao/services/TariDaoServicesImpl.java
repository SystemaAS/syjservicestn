...
public class TariDaoServicesImpl implements TariDaoServices {
	private static Logger logger = LoggerFactory.getLogger(TariDaoServicesImpl.class.getName());
	...
	public int update(Object daoObj, StringBuffer errorStackTrace){
		...
		try{
			...
			retval = this.jdbcTemplate.update( sql.toString(), new Object[] { 
						...
						dao.getTan14b(), dao.getTan14k(), dao.getTan15b(), dao.getTan15k(), dao.getTarest(), dao.getTakapa(),
	...
	private StringBuffer getSELECT_CLAUSE(){
		...
		sql.append(" tan13b, tan13k, tan14b, tan14k, tan15b, tan15k, tarest, takapa ");
