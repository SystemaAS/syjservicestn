...
@Controller
public class TvinnMaintImportResponseOutputterController_SAD002R {
	private static Logger logger = Logger.getLogger(TvinnMaintImportResponseOutputterController_SAD002R.class.getName());
		...
		try{
			...
			if(userName!=null && !"".equals(userName)){
				...
				if (list!=null){
					...
					sb.append(jsonWriter.setJsonResult_SAD002_KODTS8R_GetList(userName, list));
				}else{
