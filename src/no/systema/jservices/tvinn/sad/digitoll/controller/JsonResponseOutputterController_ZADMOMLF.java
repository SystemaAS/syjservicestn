...
import no.systema.jservices.tvinn.sad.digitoll.model.dao.services.ZadmomlfDaoServices;
...
@Controller
public class JsonResponseOutputterController_ZADMOMLF {
	private static Logger logger = LoggerFactory.getLogger(JsonResponseOutputterController_ZADMOMLF.class.getName());
	/**
	 * File: 	ZADMOMLF
	 * Member: 	ZADMOMLF Digitoll - SELECT SPECIFIC 
	 * 
	 * @Example SELECT: http://gw.systema.no:8080/syjservicestn/syjsSADMOMLF.do?user=OSCAR&...
	 *
	 * 
	 *
	*/
	@RequestMapping(value="syjsZADMOMLF.do", method={RequestMethod.GET, RequestMethod.POST})
	@ResponseBody
	public String syjsRList( HttpSession session, HttpServletRequest request) {
		...
		try{
			logger.warn("Inside syjsZADMOMLF");
			...
			if(userName!=null && !"".equals(userName)){
				...
				ZadmomlfDao dao = new ZadmomlfDao();
				...
				logger.warn("find");
				list = this.zadmomlfDaoServices.find(dao, dbErrorStackTrace);
	 ...
	 * File: 	ZADMOMLF
	 * Member: 	ZADMOMLF Digitoll - INSERT SPECIFIC 
	 * 
	 * @Example UPDATE: http://gw.systema.no:8080/syjservicestn/syjsZADMOMLF_U.do?user=OSCAR&mode=U/A/D
	 *
	 * @param session
	 * @param request
	 * @return
	...
	@RequestMapping(value="syjsZADMOMLF_U.do", method={RequestMethod.GET, RequestMethod.POST})
	@ResponseBody
	public String syjsR_U( HttpSession session, HttpServletRequest request) {
		...
		try{
			logger.warn("Inside syjsZADMOMLF_U.do");
			//TEST-->logger.info("Servlet root:" + AppConstants.VERSION_SYJSERVICES);
			String user = request.getParameter("user");
	...
	//----------------
	@Autowired
	private ZadmomlfDaoServices zadmomlfDaoServices;
