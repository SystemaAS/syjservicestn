...
public class SadmomfDaoServicesImpl implements SadmomfDaoServices {
	...
	public int insert(Object daoObj, StringBuffer errorStackTrace){
		...
		try{
			...
			sql.append(" emdkm_ff, emdkmt_ff, emrgt_ff, emrgr_ff ) ");
			...
			//främmande master ids
			dao.getEmdkm_ff(), dao.getEmdkmt_ff(), dao.getEmrgt_ff(), dao.getEmrgr_ff(),
	...
	public int deleteLight(Object daoObj, StringBuffer errorStackTrace){
		...
		try{
			...
			StringBuffer sql = new StringBuffer();
			//DEBUG --> logger.info("mydebug");
			sql.append(" UPDATE "  + TABLE_NAME+ " set emuuid = '', emmid = '', emuuid_own = '', emmid_own = '', ");
			sql.append(" emst2 = ?, emst3 = '', emdtin = ? ");  
			//id's
			sql.append(" WHERE emlnrt = ? ");
	...
	public int updateStatus2(Object daoObj, StringBuffer errorStackTrace){
		...
		try{
			...
			//params
			retval = this.jdbcTemplate.update( sql.toString(), new Object[] { dao.getEmst2(), dao.getEmlnrt(), dao.getEmlnrm() } );
	...
	public int updateStatus3(Object daoObj, StringBuffer errorStackTrace){
		...
		try{
			...
			StringBuffer sql = new StringBuffer();
			//DEBUG --> logger.info("mydebug");
			sql.append(" UPDATE sadmomf set emst3 = ? ");
			//id's
			sql.append(" WHERE emlnrt = ? ");
			sql.append(" AND emlnrm = ? ");
			
			//params
			retval = this.jdbcTemplate.update( sql.toString(), new Object[] { dao.getEmst3(), dao.getEmlnrt(), dao.getEmlnrm() } );
